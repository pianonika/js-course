...
function delegate(target, fn) {
    ...
    // addListener(clickEvent, target, fn);
}
...
function once(target, fn) {
    var onceEventListener = function (event) {
        fn();

        event.target.removeEventListener('click', onceEventListener);
    };

    target.addEventListener('click', onceEventListener);
}
